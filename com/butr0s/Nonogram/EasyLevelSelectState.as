package com.butr0s.Nonogram
{
	...
	public class EasyLevelSelectState extends FlxState
	{
		...
		{				
			...
			this.add(new FlxButton(85, 305, new FlxSprite(null, 0, 0, false, false, 200, 25, 0xffdddddd), goToMenu, null, new FlxText(0, 0, 200, 25, "Back to main menu", 0xff333333, null, 16), new FlxText(0, 0, 200, 25, "Back to main menu", 0xff000000, null, 16)));
