		...
		*/
		...
		override public function MenuState():void
		{
			...
			if (!FlxG.levels.length) 
			{
				...
				FlxG.levels.push( { 'levelData':LevelEightEasy, 'description':'TV', 'completed':'No', 'bestTime':'30:00' } );
				FlxG.levels.push( { 'levelData':LevelNineEasy, 'description':'Insect', 'completed':'No', 'bestTime':'30:00' } );
				FlxG.levels.push( { 'levelData':LevelTenEasy, 'description':'Ankh', 'completed':'No', 'bestTime':'30:00' } );
